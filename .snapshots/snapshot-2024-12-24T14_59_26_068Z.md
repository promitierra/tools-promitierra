...
import customtkinter as ctk
from .folder_creator import FolderCreator
from src.core.imagen_a_pdf import ImagenAPdfApp
...
class MainWindow(ctk.CTk):
    ...
    def __init__(self):
        ...
        # Configure window
        self.title("Herramientas ProMITIERRA")
        ...
        # Create tabs
        self.tab_pdf = self.tab_control.add("Convertir Imágenes")
        self.tab_folders = self.tab_control.add("Crear Carpetas")
        
        # Initialize components
        self.pdf_app = ImagenAPdfApp()
        self.pdf_app.crear_contenido_pestaña_principal(self.tab_pdf)
        
        self.folder_creator = FolderCreator(self.tab_folders)
        self.folder_creator.pack(expand=True, fill="both")
    ...
    def _add_footer(self):
        ...
        # Message with heart
        msg_frame = ctk.CTkFrame(footer, fg_color="transparent")
        msg_frame.pack()
        ...
        ctk.CTkLabel(
            msg_frame,
            text=" por la productividad laboral",
            font=ctk.CTkFont(size=12),
            text_color="#CCCCCC"
        ).pack(side="left")
...
class FolderCreator:
    ...
    def _setup_gui(self):
        ...
        titulo = ctk.CTkLabel(
            self.frame,
            text="Creación Masiva de Carpetas",
        ...
        descripcion = ctk.CTkLabel(
            self.frame,
            text="Carga un archivo Excel con las columnas ID y NOMBRE",
            font=ctk.CTkFont(size=12),
            text_color="#CCCCCC"
        )
        descripcion.pack(pady=(0,5))
        ...
        # Details area
        self.detalles_text = ctk.CTkTextbox(self.frame, height=200)
    ...
    def cargar_plantilla(self):
        ...
        try:
            ...
            self.detalles_text.delete("1.0", "end")
            ...
            for _, row in df.iterrows():
                try:
                    ...
                    os.makedirs(ruta_carpeta, exist_ok=True)
                    carpetas_creadas += 1
                    self.agregar_detalle(f"✓ Creada: {nombre}")
                    
                except Exception as e:
                    self.agregar_detalle(f"✗ Error: {str(e)}")
                    
            # Update status
            self.estado_label.configure(
                text=f"Estado: {carpetas_creadas} carpetas creadas"
            )
            
            messagebox.showinfo(
                "Éxito",
                f"Se han creado {carpetas_creadas} carpetas"
            )
